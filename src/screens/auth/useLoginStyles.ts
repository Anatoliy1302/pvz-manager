  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        pinKeypad: { marginTop: 8, marginBottom: 8, gap: 10 },
        pinKeypadRow: {
          flexDirection: 'row',
          justifyContent: 'center',
          gap: 12,
        ...
        pinKeypadKey: {
          ...
          alignItems: 'center',
          justifyContent: 'center',
          backgroundColor: themed.theme === 'dark' ? '#2A2A2A' : '#F5F5F7',
          borderWidth: 1,
          borderColor: themed.screen.border,
        },
        pinKeypadKeyAction: {
          backgroundColor: themed.theme === 'dark' ? '#1F1F1F' : '#ECECF0',
        },
        pinKeypadKeyPressed: { opacity: 0.65 },
        pinKeypadKeyDisabled: { opacity: 0.4 },
        pinKeypadKeyText: {
          fontSize: 24,
          fontWeight: '600',
          color: themed.screen.text,
        },
        pinKeypadKeySpacer: { width: 72, height: 56 },
