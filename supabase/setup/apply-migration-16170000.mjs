...
const sql = fs.readFileSync(
  path.resolve(process.cwd(), 'supabase/migrations/20250616170000_subscription_cancel_access.sql'),
  'utf8'
);
...
await mark.connect();
await mark.query(
  "insert into supabase_migrations.schema_migrations (version) values ('20250616170000') on conflict do nothing"
);
await mark.end();

console.log('Migration 20250616170000_subscription_cancel_access applied.');
