...
const sql = fs.readFileSync(
  path.resolve(process.cwd(), 'supabase/migrations/20250616120000_protect_profile_sensitive_fields.sql'),
  'utf8'
);
...
await mark.connect();
await mark.query(
  "insert into supabase_migrations.schema_migrations (version) values ('20250616120000') on conflict do nothing"
);
await mark.end();
console.log('Migration 20250616120000 applied');
