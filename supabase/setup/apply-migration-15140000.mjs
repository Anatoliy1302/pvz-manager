...
const sql = fs.readFileSync(
  path.resolve(process.cwd(), 'supabase/migrations/20250615140000_monetization_trial_early_adopter.sql'),
  'utf8',
);
...
await mark.connect();
await mark.query(
  "insert into supabase_migrations.schema_migrations (version) values ('20250615140000') on conflict do nothing",
);
await mark.end();
console.log('Migration 20250615140000 applied');
