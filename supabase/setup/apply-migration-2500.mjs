...
const sql = fs.readFileSync(
  path.resolve(process.cwd(), 'supabase/migrations/20250613000000_auth_hardening.sql'),
  'utf8'
);
...
await mark.connect();
await mark.query(
  "insert into supabase_migrations.schema_migrations (version) values ('20250613000000') on conflict do nothing"
);
await mark.end();
console.log('Migration 20250613000000 auth_hardening applied');
