...
const sql = fs.readFileSync(
  path.resolve(process.cwd(), 'supabase/migrations/20250618120000_query_performance_indexes.sql'),
  'utf8'
);
...
await mark.connect();
await mark.query(
  "insert into supabase_migrations.schema_migrations (version) values ('20250618120000') on conflict do nothing"
);
await mark.end();
console.log('Migration 20250618120000 applied');
