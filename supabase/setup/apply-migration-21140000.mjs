...
const sql = fs.readFileSync(
  path.resolve(process.cwd(), 'supabase/migrations/20250621140000_fix_owner_profile_phone.sql'),
  'utf8'
);
...
await mark.connect();
await mark.query(
  "insert into supabase_migrations.schema_migrations (version) values ('20250621140000') on conflict do nothing"
);
await mark.end();
console.log('Migration 20250621140000 applied');
