...
const sql = fs.readFileSync(
  path.resolve(process.cwd(), 'supabase/migrations/20250620160000_ensure_owner_profile_login.sql'),
  'utf8'
);
...
await mark.connect();
await mark.query(
  "insert into supabase_migrations.schema_migrations (version) values ('20250620160000') on conflict do nothing"
);
await mark.end();
console.log('Migration 20250620160000 applied');
